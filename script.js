...
function showContact(type) {
    ...
    if (type === "phone") {
        box.innerHTML = `
            <p>📞 +7 925 625-26-10</p>
            <a href="tel:+79256252610" class="action-btn">Позвонить</a>
        `;
    }

    if (type === "email") {
        box.innerHTML = `
            <p>📧 katakiseleva58@gmail.com</p>
            <a href="mailto:katakiseleva58@gmail.com" class="action-btn">Написать</a>
        `;
    }
    ...
    if (type === "tg") {
        box.innerHTML = `
            <p>💬 @slfthwrld</p>
            <a href="https://t.me/slfthwrld" target="_blank" class="action-btn">Написать</a>
        `;
    }
}
